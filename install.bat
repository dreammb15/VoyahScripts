...
if  %size1% ==  90437039 (echo устанавливаем версию 1.7.0) else if %size1% == 90437011 (
	echo устанавливаем версию 1.7.2
)
rem goto :err23
cd "..\"
...
if %DEBUGMODE% == 1 (
	...
	echo.
	echo после нажатия любой клавиши перейдем в основное меню
	pause >nul
	)
...
if %cunba% == 0 Echo 4 - Установка разрешения перетаскивания программ на экран пассажира
...
echo. 1. yn.apk - Яндекс.Навигатор. Работает голосовой ввод от Алисы, при правильной настройке языков программы
echo. 2. HUD+SPEED - "Стрелка-Антирадар". (требует внимательной настройки)
echo. 3. FMPLAY Интернет радио каналов FM-диапазона. Требует интернет
echo. 4. gmaps.apk Google Maps для тех кто в этом понимает. Работают без гугл-сервисов. Не обновлять.
echo. 5. KinoPoisk.apk - стандартный КиноПоиск, требует наличия подписки Яндекс.Плюс
echo. 
echo. Чтобы не перегружать установочный архив файлами, все пользовательские файлы ОТСУТСТВУЮТ
rem Их можно скачать с cunba.ru/apk или с 4pda или с AppGallery
rem Если у вас с этим сложности - обратитесь в раздел "платная помощь"
pause
if %TESTMODE% == 1 (
